...
const NoticeUpAdmin = ({ isLogin, isAdmin }) => {
      ...
      <div className="container">
        ...
        <form id="f_board" onSubmit={noticeUpdate}>
          <input
            ...
            name="notice_no"
            type="hidden"
            defaultValue={noticeVO.NOTICE_NO}
            onChange={onChange}
          />
          <table>
            <colgroup>
            ...
            <tbody>
              <tr>
                ...
                <td colSpan={4} id="td-title">
                  <input
                    ...
                    type="text"
                    style={{ width: "500px" }}
                    defaultValue={noticeVO.NOTICE_TITLE}
                    onChange={onChange}
                  />
                </td>
              </tr>
              ...
              <tr>
                ...
                <th>첨부파일</th>
                <td>
                  <FILEDOWN onClick={fileDown}>{noticeVO.NOTICE_FILE}</FILEDOWN>
                </td>
              </tr>
              <tr>
                <th>작성일</th>
