...
import { modifyProfile, memberProfile, spaymentlist, spaytotal, } from '../../../service/dbLogic';
  ...
  const callback = (res) => {
    ...
    if (success) {
      ...
      let list = {
        ...
        ORDER_AMOUNT: parseInt(orderInfo.order_amount) - parseInt(orderInfo.order_used_point),
  ...
  <>
    ...
    <P_SMALL>적립금 사용</P_SMALL>
      <div className="mt-2 mb-2 row">
        ...
        <div className="col-sm-5 d-flex">
          <input type="number" name="order_used_point" onChange={pointChange} 
