  ...
  return (
    <>
      <div className="product_container">
        <div className="clickEvent" onClick={() => {details(product.mdNo)}}>
          <div className="product_image">
            <img src={product.mdImageUrl} alt="img" style={{width: 260}}/>
          </div>
          <Card.Title className="product_name" style={{fontWeight:"bold", marginLeft:10, marginTop:5}}>{product.mdName}</Card.Title>
          <Card.Text></Card.Text>
