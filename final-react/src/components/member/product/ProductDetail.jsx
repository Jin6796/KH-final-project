    ...
    <Header />
      <div className="body_container">
        ...
        <div className="product_detail">
          <img className="product_detail_image" src={product.mdImageUrl} alt="img"/>
          <Card style={{marginLeft:300, width:700, padding:50}}>
            <Card.Title style={{fontSize:30}}>{product.mdName}</Card.Title><hr />
            <div className="product_detail_price">&nbsp;{product.mdPrice}원</div>
            ...
            <Card><div style={{fontWeight:"bold", marginLeft:4}}>할인안내</div>&nbsp;월간;문 특별 할인 혜택 {product.mdDiscount}% </Card><br />
            <Card>
            ...
            <div className="product_detail_qtt" style={{fontSize:30}}>
              <button onClick={handleDecre} className="cart_detail_btn">-</button>&nbsp;
              {quantity}&nbsp;
              <button onClick={handleIncre} className="cart_detail_btn">+</button>
            </div><br /><br />
            <div className="product_detail_sum">
              총 구매금액: {sum}원
            </div><br />
            <button className="cartBtn" onClick={() => cartBtnHandler('O')}>개별구매 장바구니</button><br />
            <button className="cartBtn" onClick={() =>  cartBtnHandler('T') }>정기구독 장바구니</button>
          </Card>
        </div>
        <br />
        <hr />
        ...
        <div className="productDetail" style={{margin: 40}}>
          ...
          <div className="product_detail_d_image" style={{alignItems: "center"}}>
            <img src={product.mdDetailImageUrl} alt="d-img"/>
          </div>
        </div>
        <hr/>
        <h4 style={{padding: 30}}>제품 후기</h4>
      </div>
    <Footer />

        {/* =========================== [[ 비로그인유저 모달창 ]] =========================== */}
    <Modal size="md" show={showLogin} onHide={handleCloseLogin} animation={false}>
      <Modal.Header closeButton>
        <Modal.Title id="example-modal-sizes-title-md">로그인 후 이용가능한 서비스입니다.</Modal.Title>
      </Modal.Header>
      <Modal.Footer>
