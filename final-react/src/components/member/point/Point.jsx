        ...
        <CONTENTS className="row">
          ...
          <div className="col-9">
            <div className="list-wrapper">
              ...
              <p style={{fontSize:"1.4rem", fontWeight:"600"}}>적립 및 사용내역</p>
                ...
                <ul style={{ marginTop: "10px" }}>
                  ...
                  <POINT_LI>
                    특정 이벤트 당첨 적립금은 이벤트 기한내에서만 사용이 가능하고 미사용 적립금은 소멸됩니다.
                  </POINT_LI>  
                  <POINT_LI>
                    적립금은 부여 된 순서로 사용 되며 해당 기간 내에 사용하지 않으실 경우, 잔여 적립금은 1년 단위로 매해 12월 31일 자동 소멸 됩니다.
                  </POINT_LI>  
                  <POINT_LI>
